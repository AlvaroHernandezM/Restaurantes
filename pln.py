...
def isWordAfirmative(word):
	listAfirmative = ['mí','mís','mi','mis','afirmativamente','evidentemente','sí','si','claro','talves','talvez','tal','supuesto','obvio','efectivamente','duda','correctamente','acuerdo']
...
def islistLunch(text):
	listLunch = ['almorzar','almorzare','almorsar','almuerzo','almorzarse','almuercito','almorzaremos','almorzará','almorzara','almuerso']
